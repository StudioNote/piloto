...
VALUES
  (
    'dv000001-0000-0000-0000-000000000001',
    'DEVIS-2026-001',
  ...
  (
    'dv000001-0000-0000-0000-000000000002',
    'DEVIS-2026-002',
  ...
  (
    'dv000001-0000-0000-0000-000000000003',
    'DEVIS-2026-003',
...
VALUES
  ('dv000001-0000-0000-0000-000000000001','dc000001-0000-0000-0000-000000000001','LA BASE',                  1, 990, 990,  1),
  ('dv000001-0000-0000-0000-000000000001','dc000001-0000-0000-0000-000000000005','Espace client sécurisé',   1, 690, 690,  2),
  ('dv000001-0000-0000-0000-000000000001','dc000001-0000-0000-0000-000000000007','Agenda interne',           1, 490, 490,  3),
  ('dv000001-0000-0000-0000-000000000001','dc000001-0000-0000-0000-000000000010','Tableau de bord',          1, 490, 490,  4),
  ('dv000001-0000-0000-0000-000000000001','dc000001-0000-0000-0000-000000000018','Multi-utilisateurs',       1, 590, 590,  5)
ON CONFLICT DO NOTHING;
...
INSERT INTO demo_piloto_devis_lignes
  (devis_id, catalogue_id, libelle, quantite, prix_unitaire_ht, total_ligne, ordre)
VALUES
  ('dv000001-0000-0000-0000-000000000002','dc000001-0000-0000-0000-000000000001','LA BASE',                  1, 990, 990,  1),
  ('dv000001-0000-0000-0000-000000000002','dc000001-0000-0000-0000-000000000002','Catégories clients',       1, 290, 290,  2),
  ('dv000001-0000-0000-0000-000000000002','dc000001-0000-0000-0000-000000000003','Historique relation',      1, 390, 390,  3),
  ('dv000001-0000-0000-0000-000000000002','dc000001-0000-0000-0000-000000000014','Suivi de stock',           1, 490, 490,  4),
  ('dv000001-0000-0000-0000-000000000002','dc000001-0000-0000-0000-000000000019','Paiement Stripe',          1, 590, 590,  5)
ON CONFLICT DO NOTHING;
...
INSERT INTO demo_piloto_devis_lignes
  (devis_id, catalogue_id, libelle, quantite, prix_unitaire_ht, total_ligne, ordre)
VALUES
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000001','LA BASE',                  1,  990,  990, 1),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000005','Espace client sécurisé',   1,  690,  690, 2),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000017','Newsletter',               1,  490,  490, 3),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000011','Devis & factures PDF',     1,  590,  590, 4),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000018','Multi-utilisateurs',       1,  590,  590, 5),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000019','Paiement Stripe',          1,  590,  590, 6),
  ('dv000001-0000-0000-0000-000000000003','dc000001-0000-0000-0000-000000000020','Connexion RDV',            1,  590,  590, 7)
ON CONFLICT DO NOTHING;
