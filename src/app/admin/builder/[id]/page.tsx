...
import { BuilderPrestationsList } from "@/components/admin/builder/BuilderPrestationsList";
...
export default async function FicheClientBuilderPage({
  params,
  searchParams,
}: {
  params: { id: string };
    ...
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 mb-8">
        <div className="flex items-start justify-between mb-5">
          ...
          <Link
            href={`/admin/builder/${client.id}/modifier`}
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 mb-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/admin/builder/${client.id}?mois=${prevMonth(currentMois)}`}
            ...
            <Link
              href={`/admin/builder/${client.id}?mois=${nextMonth(currentMois)}`}
              className="text-sm text-gray-500 hover:text-gray-800 border border-gray-200 bg-white px-3 py-1.5 rounded-lg transition-colors"
            >
              Suivant →
            </Link>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          href={`/admin/builder/${client.id}/nouvelle-prestation`}
      ...
      <BuilderPrestationsList initial={prestations ?? []} />
    </div>
  );
}
